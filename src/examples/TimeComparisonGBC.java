...
public class TimeComparisonGBC {
    public static void main(String[] args){
        ...
        boolean readSuccess = csvWR.read("./src/sampleinputs/LargeInput.csv");
        assert readSuccess;
        ...
        ParallelGaussianBayesClassifier dteSeq;
        ParallelGaussianBayesClassifier dtePar2;
        ParallelGaussianBayesClassifier dtePar4;
        ...
        List<String> sizes = new ArrayList<>(Arrays.asList("Large Set (100 x 10)", "Medium Set (30 x 3)", "Small Set (1 x 1)"));

        for(int k = 0; k < train_Xs.size(); k++){
            dteSeq = new ParallelGaussianBayesClassifier(1);
            dtePar2 = new ParallelGaussianBayesClassifier(2);
            dtePar4 = new ParallelGaussianBayesClassifier(4);
