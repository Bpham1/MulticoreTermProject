...
public class TimeComparisonRF {
    public static void main(String[] args){
        ...
        RandomForest dteSeq = new RandomForest(100, 1);
        RandomForest dtePar2 = new RandomForest(100, 2);
        RandomForest dtePar4 = new RandomForest(100,4);
