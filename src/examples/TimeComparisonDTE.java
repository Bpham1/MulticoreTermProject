...
public class TimeComparisonDTE {
    public static void main(String[] args){
        ...
        DescisionTreeEstimator dteSeq = new DescisionTreeEstimator(1);
        DescisionTreeEstimator dtePar2 = new DescisionTreeEstimator(2);
        DescisionTreeEstimator dtePar4 = new DescisionTreeEstimator(4);
