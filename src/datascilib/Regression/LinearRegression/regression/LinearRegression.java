...
public class LinearRegression {
	...
	/**
	 * A {@link Double} which acts as the set of independent variables.
	...
	/**
	 * A {@link Double} which acts as the set of dependent variables.
	...
	/**
	 * A {@link Double} which holds the value of the calculated intercept.
	 * @see #getIntercept for the getter.
	 **/
	private Double intercept;
	
	/**
	 * A {@link Double} which holds the value of the calculated slope.
	 * @see #getSlope() for the getter.
	 */
	private Double slope;
	
	/**
	 * A {@link Double} which holds the mean value of {@link #x}.
	 * @see #getxMean() for the getter.
	 */
	private Double xMean;
	
	/**
	 * A {@link Double} which holds the mean value of {@link #y}.
	...
	/**
	 * The main constructor. Takes in a pair of {@link Double} arrays.
	 ...
	 * @return the value of {@link #x} as a {@link Double} array.
	 */
	public Double[] getX() {
		return x;
	}
	 ...
	 * @return the value of {@link #slope} as a {@link Double}, possible to return null.
	 */
	 ...
	 * @return the value of {@link #xMean} as a {@link Double}.
	 */
