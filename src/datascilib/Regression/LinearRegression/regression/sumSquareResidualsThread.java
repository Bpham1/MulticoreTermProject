...
public class sumSquareResidualsThread implements Callable<Double>{
	...
	/**
	 * The {@link Double} representing the previously calculated slope/gSlope.
	 */
	Double slope;
	...
	/**
	 * The {@link java.util.concurrent.atomic.AtomicReference} of {@link Double} dataset x.
	 */
	Double[] x;
	
	/**
	 * The {@link java.util.concurrent.atomic.AtomicReference} of {@link Double} dataset y.
	 */
	Double[] y;
