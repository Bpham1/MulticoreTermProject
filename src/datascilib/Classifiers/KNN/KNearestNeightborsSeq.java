 ...
 * @since 2020-04-29
 */
public class KNearestNeightborsSeq {
    private int k;
     ...
     * @param k is an {@link Integer} k that specifies how many neighbors to consider.
     */
    public KNearestNeightborsSeq(int k) {
        this.k = k;
    }

    /**
     * Stores a 2-D List of {@link Double}s X and a 1-D List of {@link Integer}s Y.
     *
    ...
    /**
     * Helper function for predict. Takes in a {@link List} of {@link Double} that represents a single row in
     * X.
     * @param x is a {@link List} of {@link Double} that is a single row of X
     */
    ...
    /**
     * Calculates the distance between two points that are a {@link List} of {@link Double}s.
     * @param x is a {@link List} of {@link Double} that is a single row of X
     * @param x_train is a {@link List} of {@link Double} that is a single row of fitted X
     */
